    ...
    <div class="row">
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result)>0)
                    {
                        while ($row=mysqli_fetch_assoc($result)) 
                        {
                            ...
                            if(in_array("Btech", $newquali) || in_array("BE", $newquali))
                            {
        ...
        <div class="col-md-3">
            ...
            <!-- <div class="row justify-content-center">
                <h5 style="color: var(--p2); padding: 5px; text-align: center;">Btech/BE Job Opportunity </h5>
            </div>
            <hr>
            <div class="row">
                <?php
            ...
            <a href="btech_all.php">View more..</a> -->
        </div>
