    ...
    <div class="row">
        <div class="col-md-9">
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM jobs where required='fresher' order by job_uplode_date DESC limit 10";   
        ...
        <div class="col-md-3">
        	<div class="row justify-content-center">
        		<h5 style="color: var(--p2); padding: 5px; text-align: center;">Best Career Opportunities From Leading Companies For Fresher</h5>
        	</div>
        	<hr>
            <div class="row">
            	<?php
	            	$sql = "SELECT jobid,companyname FROM jobs where required='Fresher' order by companyname limit 10";   
